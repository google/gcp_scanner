...
"""This module contains two functions for retrieving information about
resources in Google Cloud Platform. it provides functions to retrieves a
list of Cloud Functions available in a specified project. The second 
function retrieves a dictionary representing the default apps and services
available in a specified project's App Engine. Both functions require a 
project identifier and an authenticated google.oauth2.credentials.Credentials
object.

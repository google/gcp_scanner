...
"""This module provides a set of functions that allow retrieval of 
information about Google Cloud projects. The functions retrieves
information about a specific project given its name along with the 
retrieves a list of all projects accessible by the provided credentials.

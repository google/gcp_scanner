...
"""This module contains functions to interact with various Google Cloud 
Platform services. The functions include retrieving information about SQL
instances, BigQuery tables and datasets, BigTable and Spanner instances. 
The functions require project name or ID, service credentials, or resource
objects to connect with the respective services.

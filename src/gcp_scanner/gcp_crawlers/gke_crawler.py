...
"""This module provides functions to retrieve information about Google 
Kubernetes Engine (GKE) clusters and images in a given project. It 
includes functions for querying the GKE API for a list of clusters and 
images, and returns the results as a list of tuples or a JSON object

...
"""This module provides a set of functions to retrieve information about
various Compute Engine resources available in a Google Cloud Platform 
project. The functions allow fetching details about Compute VMs, images, 
disks, and snapshots, and take in the project name and a resource object 
for interacting with the Compute API as arguments. The returned objects 
are in the form of dictionaries containing information about the resources.
